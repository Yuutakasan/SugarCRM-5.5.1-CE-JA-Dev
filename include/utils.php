...
*/
	'default_currency_name' => empty($default_currency_name) ? 'Japanese YEN' : $default_currency_name,
	'default_currency_symbol' => empty($default_currency_symbol) ? '\u00A5' : $default_currency_symbol,
	'default_currency_iso4217' => empty($default_currency_iso4217) ? 'JPY' : $default_currency_iso4217,
	'default_date_format' => empty($defaultDateFormat) ? 'Y/m/d' : $defaultDateFormat,
	'default_language' => empty($default_language) ? 'ja' : $default_language,
...
//	'languages' => empty($languages) ? array('en_us' => 'English (US)') : $languages,
	'languages' => empty($languages) ? array('ja' => 'Japanese(日本語)', 'en_us' => 'English (US)') : $languages,
...
*/
	'default_currency_name' => return_session_value_or_default('default_currency_name', 'Japanese YEN'),
	'default_currency_symbol' => return_session_value_or_default('default_currency_symbol', '\u00A5'),
	'default_currency_iso4217' => return_session_value_or_default('default_currency_iso4217', 'JPY'),
	'default_date_format' => 'Y/m/d',
	'default_language' => return_session_value_or_default('default_language', 'ja'),
	'default_module' => 'Home',
	'default_password' => '',
	'default_permissions' => array (
		'dir_mode' => 02770,
...
//	'languages' => array('en_us' => 'English (US)'),
	'languages' => array('ja' => 'Japanese(日本語)', 'en_us' => 'English (US)'),
...
function parse_calendardate($local_format) {
	...
	return str_replace(array("y", "・萀1・ｽ7", "a", "j"), array("Y", "Y", "Y", "d"), $calendar_format);
}

...
class ListViewDisplay {
	...
	function buildDeleteLink() {
		...
		$string = '<input name="Delete" class="button" type="button" value="'.$app_strings['LBL_DELETE_BUTTON_LABEL'].'" onclick="return sListView.send_mass_update(\'selected\', \''.$app_strings['LBL_LISTVIEW_NO_SELECTED'].'\', 1)">';
		return $string;

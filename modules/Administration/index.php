...
echo get_module_title(translate('LBL_MODULE_NAME','Administration'),
                      translate('LBL_MODULE_TITLE','Administration'), true);
...
//jkim    $admin_group_header[]= array('LBL_SUGAR_NETWORK_TITLE','',false,$admin_option_defs, 'LBL_SUGAR_NETWORK_DESC');
...
//jkim $sugar_smarty->assign('MY_FRAME',"<iframe class='teamNoticeBox' src=http://apps.sugarcrm.com/dashlet/5.2.0/sugarcrm-admin-news-dashlet.html?lang=".$current_language." width='100%' height='315px'></iframe>");

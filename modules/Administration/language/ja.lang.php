...
$mod_strings = array (
	...
	'ADMIN_EXPORT_ONLY'=>'システム管理者のみエクスポート可能',
	'EXPORT'=>'エクスポート設定',
	'EXPORT_CHARSET' => 'インポート/エクスポート時に利用するデフォルト文字セット',
	'DISABLE_EXPORT'=>'エクスポート不可',
    'DESC_DROPDOWN_EDITOR' => 'ドロップダウンの追加・削除・編集',
    ...
    'LBL_ADMINISTRATION_HOME_DESC' =>'システム全体の設定を行います。設定された内容はすべてのユーザに反映されますが、ロケール設定などの一部の内容については「アカウント情報」からそれぞれのユーザが設定を上書きすることができます。',
    'LBL_ALLOW_USER_TABS' => '利用者によるタブの非表示を許可する',
    ...
    'LBL_BUG_DESC' => 'バグトラッカーモジュールで利用するリリース情報を設定します。作成されたリリース情報は、リリースドロップダウンとして利用されます。',
    ...
    'LBL_CHOOSE_WHICH'=>'システムで表示するナビゲーションタブの設定を行います。',
	'LBL_CHOOSE_WHICH_SUBS'=>'システムで表示するサブパネルの設定を行います。',
    'LBL_CLEAR_CHART_DATA_CACHE_DESC'=>'Removes cached data files used by charts',
    'LBL_CLEAR_CHART_DATA_CACHE_TITLE'=>'チャートデータキャッシュファイルのクリア',
    'LBL_CLEAR_CHART_DATA_CACHE_FINDING'=>'Finding files...',
    'LBL_CLEAR_CHART_DATA_CACHE_DELETING1'=>'チャートデータキャッシュファイルを削除中...',
	...
	'LBL_CONFIG_SUBPANELS'=>'モジュール名を表示/非表示エリアにドラッグ&ドロップすることで設定することが出来ます。',
    'LBL_CONFIGURATOR_DESC'=>'Set up Config.php',
    'LBL_CONFIGURATOR_TITLE'=>'Configurator',
    'LBL_CONFIGURE_GROUP_TABS_DESC' => 'グループタブの作成と編集',
    'LBL_CONFIGURE_GROUP_TABS' => 'グループタブ設定',
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'システム設定',
    'LBL_CONFIGURE_SETTINGS' => 'システム全般の設定を行います。',
    'LBL_CONFIGURE_TABS' => 'タブ設定',
	'LBL_CONFIGURE_SUBPANELS' => 'サブパネル設定',
    ...
    'LBL_DIAGNOSTIC_DELETELINK' => '取得したファイルを削除',
    ...
    'LBL_DIAGNOSTIC_DESC'=>'PHPのバージョンやデータベーススキーマ等のシステム環境情報を取得します。',
    'LBL_DIAGNOSTIC_DONE' => '完了',
    'LBL_DIAGNOSTIC_DOWNLOADLINK' => '取得したファイルをダウンロード',
    'LBL_DIAGNOSTIC_EXECUTING' => '診断ツールを実行中...',
    'LBL_DIAGNOSTIC_FILESMD5'=>'&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;Copy files.md5',
    'LBL_DIAGNOSTIC_GETBEANFILES' => 'Checking that bean files exist...',
    'LBL_DIAGNOSTIC_GETCONFPHP' => 'config.phpを取得中...',
    'LBL_DIAGNOSTIC_GETCUSTDIR' => 'Getting custom dir...',
    'LBL_DIAGNOSTIC_GETMD5INFO' => 'md5を取得中...',
    'LBL_DIAGNOSTIC_GETMYSQLINFO' => 'mysql info',
    'LBL_DIAGNOSTIC_GETMYSQLTD' => 'mysql dumps',
    'LBL_DIAGNOSTIC_GETMYSQLTS' => 'mysql schema',
    'LBL_DIAGNOSTIC_GETPHPINFO' => 'phpinfo()を取得中',
    'LBL_DIAGNOSTIC_GETSUGARLOG' => 'ログファイルを取得中',
    'LBL_DIAGNOSTIC_GETTING' => 'Getting...',
    'LBL_DIAGNOSTIC_MD5'=>'MD5 情報',
    ...
    'LBL_DIAGNOSTIC_SUGARLOG'=>'SugarCRM ログファイル',
    ...
    'LBL_EMAIL_TITLE' => 'メール管理',
    'LBL_EMAIL_DESC' => 'システムが利用するメールサーバの設定やアウトバウンド・インバウンドメールの管理を行います。キャンペーンメールを利用する場合には、システムメールの設定が必須となります。',
	...
	'LBL_HIDDEN_PANELS'=>'非表示にするサブパネル',
    'LBL_HIDDEN_TABS'=>'非表示にするタブ',
    ...
    'LBL_LOCALE_DB_COLLATION_TITLE'             => 'データベース',
    'LBL_LOCALE_DB_COLLATION'                   => '照合順序',
    'LBL_LOCALE_DEFAULT_CURRENCY_ISO4217'       => 'ISO 4217 通貨コード',
    'LBL_LOCALE_DEFAULT_CURRENCY_NAME'          => '通貨',
    'LBL_LOCALE_DEFAULT_CURRENCY_SYMBOL'        => '通貨記号',
    'LBL_LOCALE_DEFAULT_CURRENCY'               => '通貨設定',
    'LBL_LOCALE_DEFAULT_DATE_FORMAT'            => '日付フォーマット',
    'LBL_LOCALE_DEFAULT_DECIMAL_SEP'            => '小数点記号',
    'LBL_LOCALE_DEFAULT_LANGUAGE'               => 'デフォルト言語',
    'LBL_LOCALE_DEFAULT_NAME_FORMAT'            => 'フルネームフォーマット',
    'LBL_LOCALE_DEFAULT_NUMBER_GROUPING_SEP'    => '1000の位 セパレータ',
    'LBL_LOCALE_DEFAULT_SYSTEM_SETTINGS'        => 'デフォルト設定',
    'LBL_LOCALE_DEFAULT_TIME_FORMAT'            => '時刻フォーマット',
    ...
    'LBL_MAILBOX_DESC' => 'システムで利用する受信箱の設定を行います。',
    'LBL_MANAGE_CONTRACTEMPLATES_TITLE'=>'Contract Types',
    'LBL_MANAGE_CURRENCIES' => '通貨設定',
    ...
    'LBL_MANAGE_USERS' => '新規ユーザの作成や既存ユーザ情報の編集・削除を行います。',
    ...
    'LBL_MASS_EMAIL_CONFIG_DESC'=> 'システム全般のメール設定を行います。',
    'LBL_MASS_EMAIL_CONFIG_TITLE'=>'システムメール設定',
    'LBL_MASS_EMAIL_MANAGER_DESC'=> 'キャンペーンで配信したメールキューの管理を行います。',
    'LBL_MASS_EMAIL_MANAGER_HEADER'=>'キャンペーンメール管理',
    ...
    'LBL_MODULE_NAME' => 'システム管理',
    'LBL_MODULE_TITLE' => 'システム管理: ホーム',
    ...
    'LBL_PASSWORD_EXP_IN'=> 'パスワードの有効期限',
    ...
    'LBL_README'                => 'Readme',
    'LBL_REBUILD_AUDIT_DESC' => '監査テーブルの再構築を行います。',
    'LBL_REBUILD_AUDIT_TITLE' => '監査テーブルの再構築',
    ...
    'LBL_REBUILD_DASHLETS_TITLE' => 'Sugarダッシュレットの再構築',
    ...
    'LBL_REBUILD_JAVASCRIPT_LANG_TITLE' => 'Javascript言語ファイルの再構築',
    ...
    'LBL_REBUILD_SCHEDULERS_TITLE' => 'スケジューラの再構築',
	...
	'LBL_RELEASE' => 'リリース情報の作成・編集・削除を行います。',
    'LBL_RENAME_TABS'=>'タブ名の編集',
    ...
    'LBL_STUDIO_DESC' => 'モジュールのフィールド・レイアウト・リレーションシップのカスタマイズを行います。',
    ...
    'LBL_SUGAR_SCHEDULER_TITLE' => 'スケジューラ設定',
    'LBL_SUGAR_SCHEDULER' => 'システムが実行するスケジュールの設定を行います。',
    ...
    'LBL_THEME_SETTINGS' => 'テーマ設定',
    'LBL_THEME_SETTINGS_DESC' => 'ユーザが利用可能なテーマを設定します。',
    ...
    'LBL_USERS_DESC' => 'ユーザの作成や削除、パスワードの再発行、ロールベースのアクセス権管理を行います。',
	...
	'LBL_VISIBLE_PANELS'=>'表示するサブパネル',
    'LBL_VISIBLE_TABS'=>'表示するタブ',
	...
	'LBL_MODULEBUILDER_DESC'=>'新規モジュールの開発を行います。',
	'LBL_SUGARPORTAL'=>'Sugar Portal',
	'LBL_SUGARPORTAL_DESC' => 'Manage the Sugar Portal',
	'LBL_CLEAR_TEMPLATE_DATA_CACHE_DESC' => 'テンプレートのキャッシュファイルを削除します',
	'LBL_CLEAR_TEMPLATE_DATA_CACHE_TITLE'=>'テンプレートキャッシュをクリア',
	'LBL_CLEAR_VARDEFS_DATA_CACHE_TITLE'=>'Vardefのキャッシュをクリア',
	'LBL_CLEAR_VARDEFS_DATA_CACHE_DESC'=>'vardefsのキャッシュファイルを削除します',
	...
	'LBL_QUICK_REPAIR_AND_REBUILD'=>'クイックリペアと再構築',
    'LBL_QUICK_REPAIR_TITLE'=>'リペアを行うモジュールを選択してください:',
	...
	'LBL_CAMPAIGN_CONFIG_TITLE'=>'キャンペーンメール設定',
	'LBL_CAMPAIGN_CONFIG_DESC'=>'キャンペーンメール配信用のメール設定を行います。',
    ...
    'LBL_QR_CBOX_CLEARTPL'=> '.tplファイルのクリア',
    'LBL_QR_CBOX_CLEARJS'=> 'Javascriptファイルのクリア',
    'LBL_QR_CBOX_CLEARVARDEFS'=> 'Vardefファイルのクリア',
    'LBL_QR_CBOX_CLEARJSLANG'=> 'Javascript言語ファイルのクリア',
    'LBL_QR_CBOX_CLEARDASHLET'=> 'Sugarダッシュレットキャッシュのクリア',
    'LBL_QR_CBOX_REBUILDAUDIT'=> '監査テーブルの再構築',
    'LBL_QR_CBOX_REBUILDEXT'=> 'Rebuild Extensions',
    'LBL_QR_CBOX_CLEARLANG'=> '言語ファイルのクリア',
    'LBL_QR_CBOX_CLEARSEARCH'=> 'Clear Unified Search Cache',
    'LBL_QR_REBUILDEXT'=>'<h3> Rebuilding Extensions...</h3>',
    'LBL_QR_CLEARSMARTY'=>'Clearing Smarty templates from cache...完了',
    'LBL_QR_XMLFILES'=>'XMLのキャッシュファイルを削除中...完了',
    'LBL_QR_CLEARDASHLET'=>'Sugarダッシュレットのキャッシュファイルを削除中...完了',
    'LBL_QR_CLEARTEMPLATE'=>'テンプレートのキャッシュファイルを削除中...完了',
    'LBL_QR_CLEARVADEFS'=>'Vardefのキャッシュを削除中...完了',
    'LBL_QR_CLEARJS'=>'Javascriptのキャッシュを削除中...完了',
    'LBL_QR_CLEARJSLANG'=>'Javascriptの言語ファイルキャッシュを削除中...完了',
    'LBL_QR_CLEARLANG'=>'言語ファイルキャッシュを削除中...完了',
    'LBL_QR_CLEARSEARCH'=>'Clearing Unified Search Cache...完了',
    'LBL_QR_REBUILDAUDIT'=>'監査テーブルを再構築中...完了',
    'LBL_QR_CBOX_CLEARSUGARFEEDCACHE'=> 'Sugarフィードのキャッシュをクリア',
    'LBL_QR_CLEARSUGARFEEDCACHE'=>'Sugarフィードのキャッシュを削除中...完了',
    'LBL_QR_CBOX_CLEARTHEMECACHE'=> 'テーマキャッシュのクリア',
    'LBL_QR_CLEARTHEMECACHE'=>'テーマキャッシュを削除中...完了',
    'LBL_REPAIR_DB_FOR'=>'Repairing DB for',
    'LBL_QR_CREATING_TABLE'=>'creating table',
    'LBL_QR_NOT_AUDIT_ENABLED'=>' not Audit Enabled...<br/>',
    'LBL_FOR'=>'for',
    'LBL_QR_CBOX_CLEARPDFFONT'=> 'PDFフォントのキャッシュファイルをクリア',
    'LBL_QR_CLEARPDFFONT'=>'PDFフォントのキャッシュファイルを削除中...完了',

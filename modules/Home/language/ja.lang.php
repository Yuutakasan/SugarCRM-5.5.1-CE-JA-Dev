...
$mod_strings = array (
  ...
  'LNK_NEW_CALL' => 'コール作成',
  'LNK_NEW_EMAIL' => 'メール作成',
  'LNK_COMPOSE_EMAIL' => 'メール作成',
  'LNK_NEW_MEETING' => 'ミーティング作成',
  'LNK_NEW_TASK' => 'タスク作成',
  'LNK_NEW_BUG' => '障害登録',
  'LBL_ADD_BUSINESSCARD' => '名刺入力',
  ...
  'LBL_DASHLET_CONFIGURE_GENERAL' => '一般設定',
  'LBL_DASHLET_CONFIGURE_FILTERS' => 'フィルタ',
  'LBL_DASHLET_CONFIGURE_MY_ITEMS_ONLY' => '自分にアサインされたレコードのみ',
  'LBL_DASHLET_CONFIGURE_TITLE' => 'タイトル',
  'LBL_DASHLET_CONFIGURE_DISPLAY_ROWS' => '表示する列の数',
//  'LBL_DASHLET_CONFIGURE_MY_ITEMS_ONLY' => 'My Items Only',

  'LBL_DASHLET_DELETE' => '削除',

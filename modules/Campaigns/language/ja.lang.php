...
$mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => 'キャンペーン 検索',
  'LBL_LIST_FORM_TITLE' => 'キャンペーン一覧',
  'LBL_NEWSLETTER_LIST_FORM_TITLE' => 'ニュースレター一覧',
  'LBL_CAMPAIGN_NAME' => 'キャンペーン名:',
  'LBL_CAMPAIGN' => 'キャンペーン:',
  'LBL_NAME' => 'キャンペーン名: ',
  'LBL_INVITEE' => 'Contacts',
  'LBL_LIST_CAMPAIGN_NAME' => 'キャンペーン名',
  ...
  'LBL_NEW_FORM_TITLE' => 'キャンペーンクイック作成',
  ...
  'LBL_HOME_START_MESSAGE' => '作成するキャンペーンタイプを選択してください。',
  ...
  'LBL_WIZ_NEWSLETTER_TITLE_STEP1' => 'キャンペーン情報',
  'LBL_WIZ_NEWSLETTER_TITLE_STEP2' => 'キャンペーン予算',
  'LBL_WIZ_NEWSLETTER_TITLE_STEP3' => 'トラッカーURL',
  ...
  'LBL_NAVIGATION_MENU_GEN1' => 'キャンペーン情報',
  'LBL_NAVIGATION_MENU_GEN2' => '予算',
  'LBL_NAVIGATION_MENU_TRACKERS' => 'トラッカー設定',
  ...
  'LBL_ADD_TRACKER' => 'トラッカーURL作成',
  'LBL_ADD_TARGET' => '追加',
  'LBL_CREATE_TARGET'=> '作成',
  'LBL_SELECT_TARGET'=> '既存のターゲットリストか選択',
  'LBL_REMOVE' => ' rem',
  'LBL_CONFIRM' => 'Start',
  'LBL_START' => '開始',
  ...
  //web to lead wizard titles
    'LBL_WEB_TO_LEAD_FORM_TITLE1' => 'リードフォーム作成 Lead Form: Select fields',
    'LBL_WEB_TO_LEAD_FORM_TITLE2' => 'リードフォーム作成: Form properties',

...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LIST_ENTRIES_PER_LISTVIEW'=>'一覧に表示する1ページあたりのアイテム数',
	'LIST_ENTRIES_PER_SUBPANEL'=>'サブパネルに表示する1ページあたりのアイテム数',

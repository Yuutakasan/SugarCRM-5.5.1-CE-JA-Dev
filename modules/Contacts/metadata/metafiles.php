 ...
 */
 $metafiles['Contacts'] = array(
	...
	'editviewdefs'    => 	'modules/Contacts/metadata/editviewdefs.php',
 	...
 	'sidecreateviewdefs'	  =>    'modules/Contacts/metadata/sidecreateviewdefs.php', //jkim add
 );
//jkim
global $current_language;
if($current_language != 'en_us') {
	foreach($metafiles['Contacts'] as $meta => $value) {
		if(file_exists('modules/Contacts/metadata/' . $current_language . '.' . $meta . '.php'))
			$metafiles['Contacts'][$meta] = 'modules/Contacts/metadata/' . $current_language . '.' . $meta . '.php';
	}
}
// end

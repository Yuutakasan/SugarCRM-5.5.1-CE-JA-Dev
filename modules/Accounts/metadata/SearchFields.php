...
$searchFields['Accounts'] = 
	array (
		...
		'email'=> array(
            'query_type' => 'default',
            'operator' => 'innerjoin',
            'innerjoin' => 'INNER JOIN email_addr_bean_rel eabr on eabr.bean_id = accounts.id INNER JOIN email_addresses ea on (ea.id = eabr.email_address_id and eabr.deleted=0 AND ea.email_address LIKE ',
